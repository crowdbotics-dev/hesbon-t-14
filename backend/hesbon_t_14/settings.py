"""
Django settings for hesbon_t_14 project.
...
WSGI_APPLICATION = 'hesbon_t_14.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hesbon_t_14 API",
    "DESCRIPTION": "API documentation for hesbon_t_14 App",
    "VERSION": "v1",
}
